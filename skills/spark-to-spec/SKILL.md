...
3. Save progress to `.spark.md` after each phase — see [FORMAT.md](FORMAT.md)
...
- **Language**: Technical founders — speak fluently in product/engineering terms (PRD, LOFA, PMF, CAC, etc.). No hand-holding.
- **Save after each phase**: Update `.spark.md` with findings, advance `current-phase`, add a Progress Log entry.
